...
export async function GET(req: NextRequest) {
  ...
  const sevenDayResult = await runSevenDayBroadcast()
  const detentionResult = await runDetentionEscalations()

  return NextResponse.json({
    sevenDayBroadcast: sevenDayResult,
    detentionEscalations: detentionResult,
  })
}
